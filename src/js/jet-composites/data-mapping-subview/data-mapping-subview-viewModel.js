  ...
  function (ko, $, componentStrings, ArrayDataProvider) {
    ...
    function ExampleComponentModel(context) {
          ...
          $.ajax({
            ...
            success: function (data, textStatus, jqXHR) {
              ...
              if (self.dataProvider().length == 0) {
                ...
                var result = alasql('SELECT * INTO XLSX("' + localStorage.getItem('column_name') + '_Template.xlsx",?) FROM ?',
      ...
      self.onMappingSelection = function (event, current, bindingContext) {
        ...
        localStorage.setItem('column_name', current.data.SOURCE_COLUMN_NAME);
