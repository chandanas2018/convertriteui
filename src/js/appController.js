  ...
  function(ko, moduleUtils, KnockoutTemplateUtils, Router, ResponsiveUtils, ResponsiveKnockoutUtils, ArrayDataProvider, OffcanvasUtils) {
     function ControllerViewModel() {
      ...
      self.footerLinks = ko.observableArray([
        ...
        new footerLink('Help', 'help', 'https://www.ritesoftware.com/contact-us/'),
        new footerLink('Report a Problem', 'report a problem', 'https://www.ritesoftware.com/contact-us/'),
        new footerLink('Contact', 'contact', 'https://www.ritesoftware.com/contact-us/'),
